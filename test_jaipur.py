...
def test_exchange_mixed_cards(game_objects):
    ...
    board.market = [Card(Resource.SPICES),Card(Resource.SPICES),Card(Resource.SPICES),Card(Resource.SPICES),Card(Resource.SPICES)]
    ...
    assert board.market == [Card(Resource.SPICES),Card(Resource.SPICES),Card(Resource.SPICES),Card(Resource.CAMEL),Card(Resource.CLOTH)]
